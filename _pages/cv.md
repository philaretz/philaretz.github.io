...
<div class="cv-header">
  ...
  <p class="cv-contact">{{ site.data.contact.email_obfuscated_mdtext }} &middot; <a href="/files/cv.pdf">Download CV (PDF)</a> &middot; <a href="/files/resume.pdf">R&eacute;sum&eacute; (PDF)</a></p>
</div>
